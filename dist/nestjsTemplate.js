...
var nestjs_1 = require("./create-app/nestjs");
var template_config_1 = __importDefault(require("./utils/template-config"));
function run(projectName) {
    return __awaiter(this, void 0, void 0, function () {
        var res, templateName, template;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    res = _a.sent();
                    templateName = 'nestjs_' + res.serverType;
